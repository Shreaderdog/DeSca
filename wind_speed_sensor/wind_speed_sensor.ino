...
float minInital = 5.00; // Minimum possible initial value
float maxInitial = 20.00; // Maximum possible initial value
float minFluctuation = -0.50; // Minimum possible fluctuation
float maxFluctuation = 0.50; // Maximum possible fluctuation
float lowestValue = 0; // Lowest value possible
float highestValue = 300; // Highest value possible
